...
class ExamplesWorkflowTests(unittest.TestCase):
    ...
    def test_release_is_draft_until_assets_are_verified(self) -> None:
        ...
        self.assertIn("--json databaseId", release)
        self.assertIn('gh api "repos/$GITHUB_REPOSITORY/releases/$release_id"', release)
        self.assertNotIn('gh api "repos/$GITHUB_REPOSITORY/releases/tags/', release)
